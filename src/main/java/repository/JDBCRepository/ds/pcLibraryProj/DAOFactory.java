...
public class DAOFactory {
    private static final Logger logger = Logger.getLogger(String.valueOf(DAOFactory.class));
    ...
    private final FlightRepository flightRepository = new JDBCFlightRepository();

    public static FlightRepository getFlightRepository() {
        return getInstance().flightRepository;
    }
